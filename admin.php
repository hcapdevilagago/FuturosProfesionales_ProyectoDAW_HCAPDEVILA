...
if (isset($_SESSION['user'])) {
    //En el caso de que exista la variable $_SESSION['user']
    $db = new Database();

    //Guardamos en la variable $user la variable de sesión $_SESSION['user']
    $user = $_SESSION['user'];

    //Solicitamos a la base de datos que nos haga una consulta para comprobar que tipo de usuario es el que se ha conectado
    $rol = $db->obtieneRol($user);
    ?>
    <!DOCTYPE html>
    <html lang="en">
        <head>
            ...
            <?php echo("<title>:: " . strtoupper($user) . " :: " . strtoupper($rol) . " ::</title>"); ?>
